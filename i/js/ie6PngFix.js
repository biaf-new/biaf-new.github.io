...
/*=====================
	...
	www.CREbSol.com
=======================*/
/* string argument can be any CSS selector, '.class, #id, h1 a' example is unnecessary, change it to what suits you!*/
DD_belatedPNG.fix('#subscribe,#rightContent .sponsors,.relaunceLFT,img,.club_inner h3');